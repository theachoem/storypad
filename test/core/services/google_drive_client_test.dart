...
void main() {
  group('GoogleDriveClient', () {
    ...
    test('provides appropriate user messages for different scenarios', () {
      ...
      expect(quotaException.userFriendlyMessage,
